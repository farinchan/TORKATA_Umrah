...
@section('content')
    ...
    <section class="contact-main pt-0 contact1 bg-grey">
        <div class="map mb-10">
            <div style="width: 100%">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d274.0460526010716!2d100.37064499983212!3d-0.9457972130883991!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2fd4b982c9fe455f%3A0x5061d73acccaf624!2sEmily%20Queen%20Home%20Photo%20Studio!5e0!3m2!1sid!2sid!4v1741505386339!5m2!1sid!2sid"
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="contact-info">
                            ...
                            <p class="mb-4">
                                Hubungi kami untuk informasi lebih lanjut tentang layanan kami. Kami akan dengan senang hati
                                membantu Anda.
                            </p>
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div id="contact-form1" class="contact-form">
                            ...
                            <p class="mb-4">
                                Kami akan menerima pertanyaan, kritik, saran, dan masukan dari anda. Silahkan isi form di
                                bawah ini.
                            </p>
                            ...
                            <form method="post" action="{{ route('contact.store') }}" id="contact_form">
                                ...
                                <div class="comment-btn text-right mt-1">
                                    <button type="submit" class="nir-btn" value="Send Message"
