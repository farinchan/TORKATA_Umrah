                            ...
                            @foreach ($list_user as $user)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Paket: {{ $user->tourSchedule->tourPackage->name ?? '-' }} <br>
                                        Jadwal: {{ $user->tourSchedule?->name ?? '-' }} <br>
                                        Tipe Paket:
                                    ...
                                    <td class="text-end d-flex">
                                        <a href="{{ route('back.tour.schedule.user.detail', [$schedule->id, $user->code]) }}"
                                            class="btn btn-light-primary">Detail</a>
                                        <a href="{{ route('back.tour.schedule.user.invoice', [$schedule->id, $user->code]) }}" class="ms-2 btn btn-light-info">
...
@section('scripts')
    <script src="{{ asset('back/js/custom/apps/user-management/users/list/user.js') }}"></script>
@endsection
