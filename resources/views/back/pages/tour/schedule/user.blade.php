                    ...
                    <div class="tab-pane fade show active" id="kt_user_view_overview_tab" role="tabpanel">
                        <div class="card card-flush mb-6 mb-xl-9">
                            <div class="card-header">
                                <div class="card-title fs-3 fw-bold">Data Wisatawan</div>
                            </div>
                                ...
                                <div class="card-body p-9">
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            placeholder="NIK" name="nik" value="{{ $user->nik }}" required />
                                        @error('nik')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ $user->birthplace }}" required />
                                                @error('birthplace')
                                                    <small class="text-danger">{{ $message }}</small>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            placeholder="No. Telp / WA" name="phone" value="{{ $user->phone }}"
                                            required />
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <input type="file" class="form-control form-control-lg form-control-solid"
                                            ...
                                            value="{{ old('file_ktp') }}" />
                                        <div>File Sebelumnya : <a href="{{ Storage::url($user->file_ktp) }}"
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <input type="text" class="form-control form-control-lg form-control-solid"
                                            placeholder="No. Paspor" name="passport" value="{{ $user->passport }}" />
                                        @error('passport')
                                            <br>
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    ...
                                    <div class="mb-5 fv-row">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" class="form-control form-control-lg form-control-solid"
                                                placeholder="Diskon" name="discount" value="{{ $user->discount }}" />
                                        </div>
