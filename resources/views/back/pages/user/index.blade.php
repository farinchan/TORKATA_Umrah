                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-toolbar">
                        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                            ...
                            <a href="{{ route('back.user.create') }}" class="btn btn-primary me-3">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                        <thead>
                            <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Staff/Agen</th>
                        ...
                        <tbody class="text-gray-600 fw-semibold">
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-bold"></span>{{ $user->email ?? '-' }}
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{ route('back.wallet.user-wallet', $user->id) }}"
                                                    class="menu-link px-3">Dompet</a>
                                            </div>
                                            <div class="menu-item px-3">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    ...
                    <div class="modal-body px-5">
                        <form class="form" method="POST" action="{{ route('back.user.delete', $user->id) }}">
                            @method('DELETE')
                            @csrf
