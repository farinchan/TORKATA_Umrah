                    ...
                    <tbody class="text-gray-600 fw-semibold">
                        @foreach ($list_jamaah as $user)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @php
                                        ...
                                        if ($user->package_type == 'quad') {
                                            $discounted_price = $user->tourSchedule->quad_price - $user->discount;
                                        } elseif ($user->package_type == 'triple') {
                                            $discounted_price = $user->tourSchedule->triple_price - $user->discount;
                                        } elseif ($user->package_type == 'double') {
                                            $discounted_price = $user->tourSchedule->double_price - $user->discount;
                                        }
                                    @endphp
                                ...
                                <td class="text-end">
                                    <a href="{{ route('back.booking.tour.history.detail', $user->code) }}"
